  ...
  return (
    <main className="w-screen min-h-screen flex items-center justify-start flex-col">
      ...
      <div className="w-full flex flex-col items-center justify-center mt-40 px-6 md:px-24 2xl:px-96 gap-12 pb-24">
        <img src="https://www.kablooe.com/wp-content/uploads/2019/08/check_mark.png" className="w-full md:w-656" alt="" />
        <h1 className="text-50px text-headingColor font-bold">Amount paid Successfully</h1>
        <NavLink
          to="/"
          className="flex items-center justify-center gap-4 cursor-pointer text-2x1 text-textColor font-semibold px-4 py-2 rounded-md border border-gray-300 hover:shadow-md"
        >
